...
class EditBlog extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (nextProps.location.state && nextProps.location.state.blog !== prevState.blog) {
      return {
        blog: nextProps.location.state.blog,
        blog_heading: nextProps.location.state.blog.blog_heading,
        blog_description: nextProps.location.state.blog.blog_description,
        // blog_image:nextProps.blog.blog_image,
        blog_id: nextProps.location.state.blog.blog_id,
      };
    } else return null;
  }
                    ...
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={(e) => this.handleChange(e)}
                        />
                        {/* { this.formValidator.message('Image', this.state.image ,'required') }								                             */}
                      </div>
                    </div>
                    <div className="col-lg-12">
                      <div className="form-group">
